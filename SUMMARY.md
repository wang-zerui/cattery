...
+ [机器学习与数据挖掘](machine-learning/about.md)
  ...
  + [南瓜书](machine-learning/pumpkin-book/about.md)
...
+ [编译原理](compile-prin/复习纲领.md)
  ...
  - [marscat笔记](compile-prin/marscat笔记/about.md)
    + [编译原理笔记1：概述编译相关的基本知识](compile-prin/marscat笔记/编译原理笔记1.md)
    
    + [编译原理笔记2：词法分析基础与模式的形式化描述](compile-prin/marscat笔记/编译原理笔记2.md)
    
    + [编译原理笔记3：有限自动机](compile-prin/marscat笔记/编译原理笔记3.md)
    
    + [编译原理笔记4：从正规式到词法分析器（1）：构造词法分析器的一般步骤、从正规式到 NFA](compile-prin/marscat笔记/编译原理笔记4.md)
    
    + [编译原理笔记5：从正规式到词法分析器（2）：NFA 记号识别、确定化、并行算法、子集法构造DFA](compile-prin/marscat笔记/编译原理笔记5.md)
    
    + [编译原理笔记6：从正规式到词法分析器（3）：DFA最小化、词法分析器的构造、Lex 使用示例](compile-prin/marscat笔记/编译原理笔记6.md)
    
    + [编译原理笔记7：语法分析](compile-prin/marscat笔记/编译原理笔记7.md)
    
    + [编译原理笔记8：语法分析（2）上下文无关文法 CFG](compile-prin/marscat笔记/编译原理笔记8.md)
    
    + [编译原理笔记9：语法分析树、语法树、二义性的消除](compile-prin/marscat笔记/编译原理笔记9.md)
    
    + [编译原理笔记10：语言与文法、正规式转CFG、正规式和CFG的关系](compile-prin/marscat笔记/编译原理笔记10.md)
    
    + [编译原理笔记11：自上而下语法分析（1）基础概念、左递归和公共左因子处理、递归下降分析（咕咕咕）](compile-prin/marscat笔记/编译原理笔记11.md)
    
    + [编译原理笔记12：自上而下语法分析（2）非递归预测分析器、FIRST & FOLLOW 集合计算](compile-prin/marscat笔记/编译原理笔记12.md)
    
    + [编译原理笔记13：自上而下语法分析（3）构造预测分析表](compile-prin/marscat笔记/编译原理笔记13.md)
    
    + [编译原理笔记14：自下而上语法分析（1）短语、句柄，规约，移进规约分析器的工作模式](compile-prin/marscat笔记/编译原理笔记14.md)
    
    + [编译原理笔记15：自下而上语法分析（2）LR 分析](compile-prin/marscat笔记/编译原理笔记15.md)
    
    + [编译原理笔记16：自下而上语法分析（3）构造 DFA、DFA 对下一步分析的指导（有效项目）](compile-prin/marscat笔记/编译原理笔记16.md)
    
    + [编译原理笔记17：自下而上语法分析（4）](compile-prin/marscat笔记/编译原理笔记17.md)
    
    + [【早期草稿】编译原理笔记18：语法制导翻译（1）](compile-prin/marscat笔记/【早期草稿】编译原理笔记18.md)
+ [数据库笔记](database/about.md)
  ...
  + [ch16](database/CH16.md)
+ [计算机网络](computer-network/about.md)
